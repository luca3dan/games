var collisionDetection = (function() {
  ...
  function checkCollisionSoft(el1, el2) {}
  function checkCollisionHard(el1, el2) {
  ...
  return {
    goHard: function(el1, el2) {
      checkCollisionHard(el1, el2);
    },
    goSoft: function(el1, el2) {
      checkCollisionSoft(el1, el2);
    },
...
CollisionDetection.prototype.getSovrapposizionePixel = function(boundingBox) {
  var imgData1 = ctx2.getImageData(boundingBox.x, boundingBox.y, boundingBox.w, boundingBox.h),
    imgData2 = ctx3.getImageData(boundingBox.x, boundingBox.y, boundingBox.w, boundingBox.h);
